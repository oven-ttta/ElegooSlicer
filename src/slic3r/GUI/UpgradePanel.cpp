...
static const wxColour TEXT_NORMAL_CLR = wxColour(22, 119, 255);
    ...
    :wxPanel(parent, id, pos, size, style)
{
    ...
    StateColor btn_bg(std::pair<wxColour, int>(wxColour(255, 255, 255), StateColor::Disabled), std::pair<wxColour, int>(wxColour(0, 102, 153), StateColor::Pressed),
                      std::pair<wxColour, int>(wxColour(0, 86, 179), StateColor::Hovered), std::pair<wxColour, int>(wxColour(22, 119, 255), StateColor::Enabled),
                      std::pair<wxColour, int>(wxColour(22, 119, 255), StateColor::Normal));
    StateColor btn_bd(std::pair<wxColour, int>(wxColour(144, 144, 144), StateColor::Disabled), std::pair<wxColour, int>(wxColour(22, 119, 255), StateColor::Enabled));
