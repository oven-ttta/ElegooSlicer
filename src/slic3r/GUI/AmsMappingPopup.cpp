...
void AmsReplaceMaterialDialog::create()
{
    ...
    label_title->SetForegroundColour(0x1677ff);
    ...
    StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(0, 102, 153), StateColor::Pressed), std::pair<wxColour, int>(wxColour(22, 119, 255), StateColor::Normal));
