    ...
    : paddingSize(10, 8)
{
    background_color = StateColor(
        ...
        std::make_pair(0x1677ff, (int) StateColor::Checked),
...
wxString btn_regular[10]  = {"#DFDFDF", "#DFDFDF", "#D4D4D4", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#262E30", "#1677ff", "#1677ff"};
wxString btn_confirm[10]  = {"#DFDFDF", "#1677ff", "#0056b3", "#1677ff", "#1677ff", "#6B6A6A", "#FEFEFE", "#FEFEFE", "#0056b3", "#1677ff"};
wxString btn_alert[10]    = {"#DFDFDF", "#DFDFDF", "#E14747", "#DFDFDF", "#DFDFDF", "#6B6A6A", "#262E30", "#FFFFFD", "#1677ff", "#1677ff"};
