...
int CLI::run(int argc, char **argv)
{
    ...
    BOOST_LOG_TRIVIAL(warning) << boost::format("cli mode, Current ElegooSlicer Version %1%")%ELEGOOSLICER_VERSION;
    ...
    for (auto const &opt_key : m_actions) {
        if (opt_key == "help") {
            ...
            m_print_config.save_to_json(m_config.opt_string(opt_key), std::string("project_settings"), std::string("project"), std::string(ORCA_COMPATIBLE_VERSION));
...
void CLI::print_help(bool include_print_options, PrinterTechnology printer_technology) const
{
    ...
    boost::nowide::cout
        << SLIC3R_APP_KEY <<"-"<< ORCA_COMPATIBLE_VERSION << ":"
        << std::endl
