...
const langMessages = {
  ...
  th: {
    "connectedPrinters": "เครื่องพิมพ์ที่เชื่อมต่อ",
    "addPrinter": "เพิ่มเครื่องพิมพ์",
    "delete": "ลบ",
    "confirm": "ยืนยัน",
    "cancel": "ยกเลิก",
    "noPrinterConnected": "ไม่มีเครื่องพิมพ์เชื่อมต่อ กรุณาไปที่ \"อุปกรณ์\" เพื่อค้นหาหรือเพิ่มเครื่องพิมพ์ใหม่",
    "requestTimeout": "คำขอหมดเวลา กรุณาตรวจสอบการเชื่อมต่อเครือข่ายของคอมพิวเตอร์และเครื่องพิมพ์",
    "homepage": {
      "title": "หน้าแรก",
      "login": "เข้าสู่ระบบ",
      "register": "ลงทะเบียน",
      ...
      "recentOpen": "เปิดล่าสุด",
      "clearAll": "ล้างทั้งหมด",
      "clear": "ล้าง",
      "openInExplorer": "เปิดใน Explorer",
      "networkPluginNotDetected": "ไม่พบปลั๊กอินเครือข่าย คลิกที่นี่เพื่อติดตั้ง",
      "clickHere": "ที่นี่",
      "toInstallIt": " เพื่อติดตั้ง",
      "onlineModels": "โมเดลออนไลน์",
    ...
    "printerManager": {
      "connectedPrinters": "เครื่องพิมพ์ที่เชื่อมต่อ",
      "addPrinter": "เพิ่มเครื่องพิมพ์",
      "localPrinters": "เครื่องพิมพ์ในเครื่อง",
      "networkPrinters": "เครื่องพิมพ์ของฉัน",
      "noPrintersAvailable": "ไม่มีเครื่องพิมพ์",
      "details": "รายละเอียด",
      "more": "เพิ่มเติม",
      "offline": "ออฟไลน์",
      "idle": "ว่าง",
      ...
      "canceled": "ยกเลิกแล้ว",
      "selfChecking": "ตรวจสอบตัวเอง",
      "autoLeveling": "ปรับระดับอัตโนมัติ",
      "pidCalibrating": "ปรับแต่ง PID",
      "resonanceTesting": "ทดสอบการสั่นสะเทือน",
      "updating": "กำลังอัปเดต",
      "fileCopying": "กำลังคัดลอกไฟล์",
      "fileTransferring": "กำลังถ่ายโอนไฟล์",
      "homing": "กำลังกลับตำแหน่งเริ่มต้น",
      "preheating": "กำลังอุ่น",
      "filamentOperating": "เอ็กซ์ทรูเดอร์กำลังทำงาน",
      "extruderOperating": "เอ็กซ์ทรูเดอร์กำลังทำงาน",
      "printCompleted": "พิมพ์เสร็จสิ้น",
      "rfidRecognizing": "กำลังตรวจจับ RFID",
      "videoComposing": "กำลังสร้างวิดีโอไทม์แลปส์",
      "emergencyStop": "หยุดฉุกเฉิน",
      "powerLossRecovery": "รอดำเนินการต่อหลังไฟดับ",
      "initializing": "กำลังเริ่มต้น",
      "idNotMatch": "ที่อยู่ IP เปลี่ยนแปลงแล้ว กรุณาเพิ่มอุปกรณ์นี้ใหม่",
      "authError": "การอนุญาตล้มเหลว กรุณาลบและเพิ่มใหม่",
      "busy": "ไม่ว่าง",
      "error": "ข้อผิดพลาด",
      "unknown": "อื่นๆ",
      "printerSettings": "การตั้งค่าเครื่องพิมพ์",
      "physicalPrinter": "เครื่องพิมพ์จริง",
      "addPrinterSuccess": "เพิ่มเครื่องพิมพ์สำเร็จ",
      "modifySuccess": "แก้ไขสำเร็จ",
      "loginToView": "กรุณา{0}เพื่อดู",
      "isNotMainClient": "กรุณาตรวจสอบว่ามีไคลเอนต์หลายตัวเปิดอยู่หรือไม่ และดำเนินการต่อที่ไคลเอนต์หลัก",
      "login": "เข้าสู่ระบบ",
    },
    "addPrinterDialog": {
      "addPrinter": "เพิ่มเครื่องพิมพ์",
      ...
      "connectable": "สามารถเชื่อมต่อได้",
      "bindable": "สามารถผูกได้",
      "connected": "เชื่อมต่อแล้ว",
      "binded": "ผูกแล้ว",
      "connectToPrinter": "เชื่อมต่อเครื่องพิมพ์",
      "bindPrinter": "ผูกเครื่องพิมพ์",
      "refresh": "รีเฟรช",
      "close": "ปิด",
      "cannotFindPrinter": "หาเครื่องพิมพ์ไม่พบ?",
      "connect": "เชื่อมต่อ",
      "help": "ช่วยเหลือ",
      "helpMessage": "{'กรุณาตรวจสอบว่าเครื่องพิมพ์เชื่อมต่อกับเครือข่ายและอยู่ในเครือข่ายเดียวกันกับซอฟต์แวร์ปัจจุบัน หากยังหาไม่พบหลังจากรีเฟรช สามารถลองเพิ่มด้วยตนเอง'}",
      "ok": "ตกลง",
      "pleaseSelectPrinter": "กรุณาเลือกเครื่องพิมพ์",
      "bindingInProgress": "กำลังผูก...",
      "bindingInProgressTip": "หากไม่มีการตอบสนองเป็นเวลานาน กรุณาไปที่เครื่องพิมพ์เพื่อยืนยันการผูก",
      "alreadyBinded": "เครื่องพิมพ์นี้ถูกผูกแล้ว",
      "alreadyConnected": "เครื่องพิมพ์นี้เชื่อมต่อแล้ว"
    },
    "manualForm": {
      "printerModel": "รุ่นเครื่องพิมพ์",
      "advanced": "ขั้นสูง",
      "selectVendor": "เลือกผู้ผลิต",
      "selectModel": "เลือกรุ่น",
      "printerName": "ชื่อเครื่องพิมพ์",
      "hostType": "ประเภทโฮสต์",
      "selectHostType": "เลือกประเภทโฮสต์",
      "connectionMethod": "วิธีการเชื่อมต่อ/ผูก",
      "selectConnectionMethod": "เลือกวิธีการเชื่อมต่อ/ผูก",
      "networkTypeLan": "LAN",
      "networkTypeWan": "WAN",
      "hostNameIpUrl": "ชื่อโฮสต์, IP หรือ URL",
      "hostSamples": "เช่น 192.168.1.1 หรือ 192.168.1.1:81",
      "accessCode": "รหัสเข้าถึง",
      "accessCodePlaceholder": "ป้อนรหัสเข้าถึง (ไม่บังคับ)",
      "pinCode": "รหัส PIN",
      "pinCodePlaceholder": "ป้อนรหัส PIN (ไม่บังคับ)",
      "pinCodePlaceholderRequired": "ป้อนรหัส PIN",
      "webUrl": "UI อุปกรณ์",
      "password": "API/รหัสผ่าน",
      "httpsCAFile": "ไฟล์ HTTPS CA",
      "preview": "ดูตัวอย่าง",
      "httpsCAFileNote": "ไฟล์ HTTPS CA เป็นทางเลือก จำเป็นเฉพาะเมื่อใช้ HTTPS กับใบรับรองที่ลงนามเอง",
      "manualAddNote": "กรุณาตรวจสอบว่าเฟิร์มแวร์เครื่องพิมพ์อัปเดตเป็นเวอร์ชันล่าสุด",
      "ignoreCertRevocation": "ข้ามการตรวจสอบการเพิกถอนใบรับรอง HTTPS",
      "pleaseSelectVendor": "กรุณาเลือกผู้ผลิต",
      "pleaseSelectPrinterModel": "กรุณาเลือกรุ่นเครื่องพิมพ์",
      "pleaseEnterPrinterName": "กรุณาป้อนชื่อเครื่องพิมพ์",
      "lengthShouldBe1To20": "ความยาวควรเป็น 1 ถึง 20 ตัวอักษร",
      "lengthShouldBe1To30": "ความยาวควรเป็น 1 ถึง 30 ตัวอักษร",
      "pleaseSelectHostType": "กรุณาเลือกประเภทโฮสต์",
      "pleaseSelectConnectionMethod": "กรุณาเลือกวิธีการเชื่อมต่อ/ผูก",
      "pleaseEnterHostNameIpUrl": "กรุณาป้อนชื่อโฮสต์, IP หรือ URL",
      "pleaseEnterPinCode": "กรุณาป้อนรหัส PIN",
      "invalidPrinterName": "มีอักขระพิเศษที่ไม่ถูกต้อง"
    },
    "printerAccessAuth": {
      "enterAccessCode": "กรุณาตรวจสอบรหัสเข้าถึงบนหน้าจอและป้อนด้านล่างเพื่อเพิ่มเครื่องพิมพ์",
      "cannotAccessCode": "ไม่สามารถรับรหัสเข้าถึงได้?",
      "close": "ปิด",
      "connect": "เชื่อมต่อ",
      "help": "ช่วยเหลือ",
      "helpMessage": "{'กรุณาตรวจสอบว่าเฟิร์มแวร์เครื่องพิมพ์อัปเดตเป็นเวอร์ชันล่าสุดและเปิดใช้งานโหมด \"LAN เท่านั้น\"'}",
      "ok": "ตกลง",
      "pleaseEnterCompleteAccessCode": "กรุณาป้อนรหัสเข้าถึง 6 หลักให้ครบ",
      "connectToPrinter": "เชื่อมต่อเครื่องพิมพ์",
      "bindPrinter": "ผูกเครื่องพิมพ์",
      "failedToAddPrinterInvalidAccessCode": "รหัสเข้าถึงไม่ถูกต้อง ไม่สามารถเพิ่มเครื่องพิมพ์ได้ กรุณาตรวจสอบและลองอีกครั้ง",
      "failedToAddPrinter": "ไม่สามารถเพิ่มเครื่องพิมพ์ได้ กรุณาตรวจสอบเครือข่ายของคอมพิวเตอร์และเครื่องพิมพ์แล้วลองอีกครั้ง"
    },
    "printerPinAuth": {
      "enterPinCode": "กรุณาตรวจสอบรหัส PIN บนหน้าจอและป้อนด้านล่างเพื่อผูกเครื่องพิมพ์",
      "cannotPinCode": "ไม่สามารถรับรหัส PIN ได้?",
      "close": "ปิด",
      "connect": "ผูก",
      "help": "ช่วยเหลือ",
      "helpMessage": "กรุณาตรวจสอบว่าเฟิร์มแวร์เครื่องพิมพ์อัปเดตเป็นเวอร์ชันล่าสุดและตรวจสอบรหัส PIN บนหน้าจอ",
      "ok": "ตกลง",
      "pleaseEnterCompletePinCode": "กรุณาป้อนรหัส PIN 6 หลักให้ครบ"
    },
    "printerSetting": {
      ...
      "enterPrinterName": "ป้อนชื่อเครื่องพิมพ์",
      "enterHostIpUrl": "ป้อนโฮสต์, IP หรือ URL",
      "pleaseEnterPrinterName": "กรุณาป้อนชื่อเครื่องพิมพ์",
      "lengthShouldBe1To20": "ความยาวควรเป็น 1 ถึง 20 ตัวอักษร",
      "lengthShouldBe1To30": "ความยาวควรเป็น 1 ถึง 30 ตัวอักษร",
      "pleaseEnterHostNameIpUrl": "กรุณาป้อนชื่อโฮสต์, IP หรือ URL",
      "confirmDeletePrinter": "คุณแน่ใจหรือไม่ว่าต้องการลบเครื่องพิมพ์นี้?",
      "pleaseEnterValidHostNameIpUrl": "กรุณาป้อนชื่อโฮสต์, IP หรือ URL ที่ถูกต้อง",
    ...
    "filamentSync": {
      "pleaseSelectPrinter": "กรุณาเลือกเครื่องพิมพ์",
      "filamentInformation": "ข้อมูลวัสดุพิมพ์",
      "printerOffline": "ข้อผิดพลาดการเชื่อมต่อเครื่องพิมพ์ กรุณาตรวจสอบเครือข่ายของคอมพิวเตอร์และเครื่องพิมพ์แล้วลองอีกครั้ง",
      "noFilamentInfo": "ไม่มีข้อมูลวัสดุพิมพ์จากเครื่องพิมพ์ ตรวจสอบว่าใส่สปูลแล้วและคลิกรีเฟรช หรือลองอีกครั้ง",
      "cancel": "ยกเลิก",
      "sync": "ซิงค์",
      "failedToSyncFilament": "ซิงค์วัสดุพิมพ์ไม่สำเร็จ",
      "warningTips": "โปรเจกต์นี้มีข้อมูลวัสดุพิมพ์อยู่แล้ว การยืนยันซิงค์จะเขียนทับการตั้งค่าที่มีอยู่"
    },
    "printSend": {
      "printer": "เครื่องพิมพ์",
      "noPrinter": "ไม่มีเครื่องพิมพ์",
      "pleaseConnectPrinter": "กรุณาเชื่อมต่อเครื่องพิมพ์",
      "texturedA": "ด้าน A พื้นผิว",
      "smoothB": "ด้าน B เรียบ",
      "autoRefill": "เติมวัสดุพิมพ์อัตโนมัติ",
      "switchToDeviceTab": "อัปโหลดและสลับไปหน้าเครื่องพิมพ์",
      "uploadAndPrint": "อัปโหลดและพิมพ์",
      "printOptions": "ตัวเลือกการพิมพ์",
      "autoBedLeveling": "ปรับระดับอัตโนมัติ",
      "timelapse": "ไทม์แลปส์",
      "canvas": "CANVAS",
      "noMapping": "ไม่มีการจับคู่",
      "cancel": "ยกเลิก",
      "upload": "อัปโหลด",
      "someFilamentsNotMapped": "ตรวจพบวัสดุพิมพ์ที่ไม่ได้จับคู่ ไม่สามารถเริ่มพิมพ์ได้",
      "printerMmsNotConnected": "CANVAS ไม่ได้เชื่อมต่อ ไม่สามารถเริ่มพิมพ์ได้",
      "filamentMapping": "การจับคู่วัสดุพิมพ์",
      "filamentTypeNotMatch": "ประเภทวัสดุพิมพ์ไม่ตรงกัน",
      "printerModelNotMatch": "เครื่องพิมพ์ที่เลือกไม่ตรงกับไฟล์ gcode อาจทำให้การพิมพ์ล้มเหลวหรือเครื่องพิมพ์เสียหาย! แนะนำให้ slice ใหม่หรือเลือกเครื่องพิมพ์ที่ถูกต้อง",
      "bedTypeNotMatch": "ประเภทฐานพิมพ์ที่เลือกไม่ตรงกับไฟล์ G-code กรุณายืนยันก่อนเริ่มพิมพ์",
      "printerNotConnected": "เครื่องพิมพ์ไม่ได้เชื่อมต่อ",
      "print": "พิมพ์",
      "printerBusyWarning": "เครื่องพิมพ์อาจไม่สามารถเริ่มการถ่ายโอน/พิมพ์ได้ กรุณาเลือกเครื่องพิมพ์ใหม่หรือรีเฟรชสถานะ",
      "printCompleteWarning": "กรุณาตรวจสอบว่าเครื่องพิมพ์ถูกเคลียร์แล้วเพื่อหลีกเลี่ยงการชนหรือความเสียหายเมื่อเริ่มพิมพ์ใหม่"
    }
  }
};
