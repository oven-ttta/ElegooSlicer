...
if (MSVC)
    ...
    ExternalProject_Add(dep_GMP
        ...
        BUILD_IN_SOURCE ON
        CONFIGURE_COMMAND chmod +x configure && env "CFLAGS=${_gmp_ccflags}" "CXXFLAGS=${_gmp_ccflags}" ./configure ${_cross_compile_arg} --enable-shared=no --enable-cxx=yes --enable-static=yes "--prefix=${DESTDIR}" ${_gmp_build_tgt}
